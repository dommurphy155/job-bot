...
async def schedule_scraping():
    while True:
        ...
        # Convert scrape times strings to time objects if needed
        for scrape_time_str in SCRAPE_TIMES:
            ...
            if now >= scrape_time:
                ...
                # Sleep until next scrape time to avoid duplicate runs in same scrape window
    ...
    while True:
        ...
        for send_time_str in SEND_TIMES:
            ...
            if now >= send_time:
                ...
                run_cleanup()
                # Sleep to avoid duplicate sending in same window
                await asyncio.sleep(60)
                break
        await asyncio.sleep(30)
